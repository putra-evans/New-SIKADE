...
class Model_users extends CI_Model
{
	...
	private function _get_datatables_query($param)
	{
		...
		$this->db->join('ms_instansi e', 'a.id_instansi = e.id_instansi', 'left');
		...
		//instansi
		if (isset($post['id_instansi']) and $post['id_instansi'] != '')
			$this->db->where('a.id_instansi', $post['id_instansi']);
		$i = 0;
	...
	public function getDataDetailUsers($token)
	{
		...
		$this->db->from('xi_sa_users a');
		$this->db->join('xi_sa_users_privileges b', 'a.id_users = b.id_users', 'left');
		$this->db->join('ms_instansi c', 'a.id_instansi = c.id_instansi', 'left');
