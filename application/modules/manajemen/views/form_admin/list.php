  ...
  <div class="row" id="formParent">
    <div class="col-xs-12 col-sm-12">
      <div class="btn-toolbar" style="margin-bottom: 15px">
        <a type="button" href="<?php echo site_url('manajemen/users'); ?>" class="btn btn-inverse" name="button" style="padding:12px 16px;"><b><i class="fa fa-table"></i> Data User</b></a>
      ...
      <div class="modal-body" style="padding:15px 15px 5px 15px;">
          ...
          <div class="col-xs-12 col-sm-6">
            <div class="form-group required">
              ...
              <div class="input-group">
                <input type="password" class="form-control" name="password" id="password" placeholder="Password" value="<?php echo $this->input->post('password', TRUE); ?>">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-8">
            <div class="form-group required">
              <label for="blokir" class="control-label"><b>Instansi <font color="red">*</font></b></label>
              <?php echo form_dropdown('id_instansi', $nm_instansi, $this->input->post('id_instansi'), 'class="select-data" id="id_instansi"'); ?>
              <div class="help-block"></div>
            </div>
          </div>
  ...
  function getDataUser(token) {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        $('#blokir').select2('val', data.message.blokir);
        $('#status').select2('val', data.message.status);

        if ($(data.message.scan_identitas).val() != '') {
          document.getElementById('foto').src = "<?php echo base_url('upload/file/registrasi/') ?>" + data.message.scan_identitas
        } else {
          console.log(kosong)
        }
