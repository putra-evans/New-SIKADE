<div class="container">
  <div class="panel-heading">
    <h4>Detail Permohonan <u><?= !empty($data_pepeng_pend) ? ($data_pepeng_pend[0]->nama_lengkap) : ($data_pepeng_adm[0]->nama_lengkap) ?> </u> </h4>
  </div>
        ...
        <div class="tab-pane active" id="home1">
          <div class="panel panel-inverse">
            ...
            <div class="panel-body">
              <div class="col-md-offset-1 col-xs-10">
                ...
                <div class="row">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-6">
                      ...
                      <input type="text" class="form-control tooltips" name="nama_lengkap" id="nama_lengkap" placeholder="Nama Lengkap" value="<?= $data_pepeng_diri[0]->nama_lengkap ?>" data-trigger="hover" data-original-title="Nama Lengkap yang akan digunakan" readonly style="background-color:white">
                ...
                <div class="row">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-6">
                      <input type="number" class="form-control tooltips" name="nik" id="nik" placeholder="NIK(Nomor KTP Elektronik)" value="<?= $data_pepeng_diri[0]->nik ?>" data-trigger="hover" data-original-title="NIK(Nomor KTP Elektronik) yang akan digunakan" readonly style="background-color:white">
                      <div class="help-block"></div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control tooltips" name="alamat" id="alamat" placeholder="Alamat Anda" value="<?= $data_pepeng_diri[0]->alamat ?>" data-trigger="hover" data-original-title="Alamat Anda" readonly style="background-color:white">
                      <div class="help-block"></div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control tooltips" name="pemda_lembaga_umum" id="pemda_lembaga_umum" placeholder="Pemda/Lembaga/Umum" value="<?= $data_pepeng_diri[0]->pemda_lembaga_umum ?>" data-trigger="hover" data-original-title="Pemda/Lembaga/Umum" readonly style="background-color:white">
                      <div class="help-block"></div>
                    </div>
                  </div>
                </div>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <center>
                                <a class="btn btn-xs btn-primary" target="_blank" href="<?= site_url('upload/file/administrasi/pepeng/' . $year . '/' . $month . '/' . $nik . '/' . $file_ktp) ?>"><i class="fa fa-eye"></i></a>

                                <a class="btn btn-xs btn-primary" download href="<?= site_url('upload/file/administrasi/pepeng/' . $year . '/' . $month . '/' . $nik . '/' . $file_ktp) ?>"><i class="fa fa-download"></i></a>
                              </center>
                            </td>
                          </tr>
                        <?php
                    ...
                    <table class="table table-bordered table-striped" width="100%">
                      ...
                      <tbody>
                        ...
                        if (empty($data_pepeng_adm)) { ?>
                          ...
                          <?php } else {
                          foreach ($data_pepeng_adm as $key => $list) :
                            $abc = $list->nama_file;
                            $file_ktp   = $cek_file['file_ktp'];
                            $year       = $cek_file['year'];
                            $month      = $cek_file['month'];
                              ...
                              <td>
                                <center>
                                  ...
                                  if (empty($abc)) {
                                    ...
                                    <a class="btn btn-xs btn-primary" target="_blank" href="<?= site_url('upload/file/administrasi/pepeng/' . $year . '/' . $month . '/' . $nik . '/' . $abc) ?>"><i class="fa fa-eye"></i></a>

                                    <a class="btn btn-xs btn-primary" download href="<?= site_url('upload/file/administrasi/pepeng/' . $year . '/' . $month . '/' . $nik . '/' . $abc) ?>"><i class="fa fa-download"></i></a>
                                  <?php } ?>
              ...
              <?php echo form_open_multipart(site_url('master-kade/adminpepeng/updatestatuspermohonan'), array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'formEntry')); ?>
            ...
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <div class="btn-toolbar">
                  ...
                  <a href="<?php echo site_url('master-kade/adminpepeng') ?>" class="btn-warning btn tes"><i class="fa fa-times"></i> Batal</a>
                </div>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
  ...
  function formReset() {
    $('#formEntry').attr('action', site + 'master-kade/adminpepeng/updatestatuspermohonan');
    $('#errEntry').html('');
