<div class="container">
  <div class="panel-heading">
    <h4>Administrasi Izin Ke Luar Negeri dengan Alasan Penting bagi KDH/Wakil KDH</h4>
  </div>
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="home1">
          <div class="panel panel-info">
            ...
            <?php echo form_open_multipart(site_url('master-kade/adminluarnegeri/create/save-register'), array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'formEntry')); ?>
            <?php echo form_hidden('no_registrasi', !empty($data_luarnegeri) ? $data_luarnegeri['no_urut'] : ''); ?>
            <div class="panel-body">
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="input1 form-control tooltips" name="nama_lengkap" id="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo !empty($data_luarnegeri) ? $data_luarnegeri['nama_lengkap'] : set_value('nama_lengkap'); ?>" data-trigger="hover" data-original-title="Nama Lengkap yang akan digunakan">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="number" class="input1 form-control tooltips" name="nik" id="nik" placeholder="NIK(Nomor KTP Elektronik)" value="<?php echo !empty($data_luarnegeri) ? $data_luarnegeri['nik'] : set_value('nik'); ?>" data-trigger="hover" data-original-title="NIK(Nomor KTP Elektronik) yang akan digunakan">
                  <div class="help-block"></div>
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="input1 form-control tooltips" name="alamat" id="alamat" placeholder="Alamat Anda" value="<?php echo !empty($data_luarnegeri) ? $data_luarnegeri['alamat'] : set_value('alamat'); ?>" data-trigger="hover" data-original-title="Alamat Anda">
                  <div class="help-block"></div>
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="input1 form-control tooltips" name="pemda_lembaga_umum" id="pemda_lembaga_umum" placeholder="Pemda/Lembaga/Umum" value="<?php echo !empty($data_luarnegeri) ? $data_luarnegeri['pemda_lembaga_umum'] : set_value('pemda_lembaga_umum'); ?>" data-trigger="hover" data-original-title="Pemda/Lembaga/Umum">
                  <div class="help-block"></div>
                </div>
              </div>
            ...
            <div class="col-xs-12">
              <div class="panel panel-midnightblue">
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-offset-1 col-xs-9">
                      ...
                      <div class="table-responsive">
                        <input type="hidden" name="id_adminluarnegeri" id="id_adminluarnegeri">
                        <input type="hidden" name="status" id="status" value="<?= $data_luarnegeri['status'] ?>">
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                      <span class="btn btn-magenta btn-file pulsate">
                                        ...
                                        <input type="file" class="uploadDokumen" name="file_doc_<?= $i; ?>" id="file_doc_<?= $i; ?>" value="<?php echo !empty($data_luarnegeri) ? $data_luarnegeri['no_urut'] : ''; ?>" data-idadminupload="<?= base64_encode($list->id_adminupload)  ?>" data-idadminluarnegeri="<?= $this->uri->segment(5); ?>" data-idadministrasi="<?= base64_encode($list->id_administrasi)   ?>" data-id="<?= $i ?>">
                                  ...
                                  <td>
                                    <center>
                                      <?php if (!empty($abc)) { ?>
                                        <a class="btn btn-xs btn-primary" target="_blank" href="<?= site_url('upload/file/administrasi/luarnegeri/' . $year . '/' . $month . '/' . $nik . '/' . $abc) ?>">View</a>
                                      <?php } else {
                    ...
                    <div class="col-md-offset-1 col-xs-9">
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered table-striped" width="100%">
                          ...
                          <tbody>
                            <?php $i = 1;
                            if (empty($list_dokumenpendukung)) { ?>
                              <tr>
                                <td align="center" colspan="4">Tidak Ada Dokumen Pendukung</td>
                              </tr>
                              <?php } else {
                              foreach ($list_dokumenpendukung as $key => $list) :
                                $abc = $list->nama_file;
                                $file_ktp   = $cek_file['file_ktp'];
                                $year       = $cek_file['year'];
                                $month      = $cek_file['month'];
                                  ...
                                  <td>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                      <span class="btn btn-magenta btn-file pulsate">
                                        ...
                                        <input type="file" class="uploadDokPend" name="file_doc_pend<?= $i; ?>" id="file_doc_pend<?= $i; ?>" value="<?php echo !empty($data_luarnegeri) ? $data_luarnegeri['no_urut'] : ''; ?>" data-idadminupload="<?= base64_encode($list->id_adminupload)  ?>" data-idadminluarnegeri="<?= $this->uri->segment(5); ?>" data-idadministrasi="<?= base64_encode($list->id_administrasi)   ?>" data-id="<?= $i ?>">
                                      </span>
                                      <span class="fileinput-filename"></span>
                                      <a href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none">&times;</a>
                                    </div>
                  ...
                  <?php echo form_open_multipart(site_url('master-kade/adminluarnegeri/create/save-ajukan'), array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'formAjukan')); ?>
                  <div class="panel-footer">
                    <div class="row">
                      <div class="col-sm-6 col-sm-offset-3">
                        <div class="btn-toolbar">
                          <input type="hidden" value="<?php echo base64_encode($data_luarnegeri['id_adminluarnegeri'])  ?>" name="id_adminluarnegeri">
                          <input type="hidden" value="<?php echo $data_luarnegeri['nama_lengkap']  ?>" name="nama_lengkap">
                          <button class="btn-success btn" type="submit" name="saveAjukan" id="saveAjukan"><i class="fa fa-check"></i> Ajukan</button>
                          <a href="<?= site_url('master-kade/adminluarnegeri') ?>" class="btn-warning btn"><i class="fa fa-times"></i> Batal Simpan</a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="table-responsive">
                        <table class="table table-condensed">
                          <h3><strong>Nomor Registrasi: <?php echo !empty($data_luarnegeri) ? $data_luarnegeri['no_urut'] : ''; ?></strong></h3>

                          <tbody>
                            <tr>
                              <td>Tanggal Registrasi</td>
                              <td>: <strong><?php echo !empty($data_luarnegeri) ? tgl_indo_registrasi($data_luarnegeri['create_date']) : ''; ?></strong></td>
                            </tr>
                            <tr>
                              <td>Jam Registrasi</td>
                              <td>: <strong><?php echo !empty($data_luarnegeri) ? tgl_indo_jam($data_luarnegeri['create_date']) : ''; ?> WIB</strong></td>
                            </tr>
                            <tr>
                              <td>Nama Lengkap</td>
                              <td>: <strong><?php echo !empty($data_luarnegeri) ? $data_luarnegeri['nama_lengkap'] : ''; ?></strong></td>
                            </tr>
                            <tr>
                              <td>NIK (Nomor Induk Kependudukan)</td>
                              <td>: <strong><?php echo !empty($data_luarnegeri) ? $data_luarnegeri['nik'] : ''; ?></strong></td>
                            </tr>
                            <tr>
                              <td>Alamat</td>
                              <td>: <strong><?php echo !empty($data_luarnegeri) ? $data_luarnegeri['alamat'] : ''; ?></strong></td>
                            </tr>
                            <tr>
                              <td>Pemda/Lembaga/Umum</td>
                              <td>: <strong><?php echo !empty($data_luarnegeri) ? $data_luarnegeri['pemda_lembaga_umum'] : ''; ?></strong></td>
                            </tr>
                            <tr>
                              <td>Nama Layanan</td>
                              <td>: <strong><?php echo !empty($data_luarnegeri) ? $data_luarnegeri['nm_layanan'] : ''; ?></strong></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
...
<script type="text/javascript">
  ...
  $('.uploadDokumen').change(function(e) {
    ...
    var id_adminluarnegeri = $(this).data('idadminluarnegeri');
    ...
    data.append('id_adminluarnegeri', id_adminluarnegeri);
    data.append('id_administrasi', id_administrasi);
    data.append(csrfName, $('input[name="' + csrfName + '"]').val());
    $.ajax({
      url: '<?= site_url('master-kade/adminluarnegeri/create/insertadministrasi') ?>',
      type: 'post',
      dataType: 'json',
      data: data,
      cache: false,
  ...
  $('.uploadDokPend').change(function(e) {
    ...
    data.append(csrfName, $('input[name="' + csrfName + '"]').val());
    $.ajax({
      url: '<?= site_url('master-kade/adminluarnegeri/create/insertpendukung') ?>',
      type: 'post',
      dataType: 'json',
      data: data,
      cache: false,
  ...
  function formReset() {
    $('#formEntry').attr('action', site + 'master-kade/adminluarnegeri/create');
    $('#errEntry').html('');
              ...
              $.ajax({
                ...
                if (data.status == 0) {
                  ...
                  $('#errEntry').html('<div class="alert alert-dismissable alert-success">' +
                    ...
                    '</div>');
                  // console.log(data)
                  window.location.href = site + 'master-kade/adminluarnegeri/create/new-register/' + data.kode;
      ...
      buttons: {
        ...
        "main": {
          ...
          callback: function(response) {
            if (response) {
              $.ajax({
                url: site + 'master-kade/adminluarnegeri/deletedokumenpendukung',
                type: "POST",
                data: postData,
                dataType: "json",
              }).done(function(data) {
  ...
  $(document).on('click', '.printPdf', function(e) {
    var luarnegeri = $('input[name="no_registrasi"]').val();
    url = site + 'master-kade/adminluarnegeri/export-to-pdf?registration_number=' + luarnegeri;
  ...
  jQuery(document).ready(function() {
    ...
    var id_adminluarnegeri = "<?php echo  !empty($data_luarnegeri) ? $data_luarnegeri['id_adminluarnegeri'] : '' ?>";
    if (id_adminluarnegeri != '') {
      $('#id_adminluarnegeri').val(id_adminluarnegeri);
      $('[href="#upload1"]').tab('show');
      $('.input1').attr('readonly', true);
    }
    var status = "<?php echo  $data_luarnegeri['status'] ?>";
    if (status == 'diajukan') {
      $('#status').val(status);
      $('[href="#profile1"]').tab('show');
    }
