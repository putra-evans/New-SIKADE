<div class="container">
  <div class="panel-heading">
    <h4>Administrasi Cuti Kampanye KDH dan Wakil KDH</h4>
  </div>
          ...
          <div class="panel panel-success">
            ...
            <div class="panel-body">
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control tooltips" name="nama_lengkap" id="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo !empty($data_cuka) ? $data_cuka['nama_lengkap'] : set_value('nama_lengkap'); ?>" data-trigger="hover" data-original-title="Nama Lengkap yang akan digunakan">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control tooltips" name="nik" id="nik" placeholder="NIK(Nomor KTP Elektronik)" value="<?php echo !empty($data_cuka) ? $data_cuka['nik'] : set_value('nik'); ?>" data-trigger="hover" data-original-title="NIK(Nomor KTP Elektronik) yang akan digunakan">
                  <div class="help-block"></div>
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control tooltips" name="alamat" id="alamat" placeholder="Alamat Anda" value="<?php echo !empty($data_cuka) ? $data_cuka['alamat'] : set_value('alamat'); ?>" data-trigger="hover" data-original-title="Alamat Anda">
                  <div class="help-block"></div>
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control tooltips" name="pemda_lembaga_umum" id="pemda_lembaga_umum" placeholder="Pemda/Lembaga/Umum" value="<?php echo !empty($data_cuka) ? $data_cuka['pemda_lembaga_umum'] : set_value('pemda_lembaga_umum'); ?>" data-trigger="hover" data-original-title="Pemda/Lembaga/Umum">
                  <div class="help-block"></div>
                </div>
              </div>
                              ...
                              <td>
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                  <span class="btn btn-magenta btn-file pulsate">
                                    <span class="fileinput-new">Pilih file</span>
                                    <span class="fileinput-exists">Change</span>
                                    <input type="file" name="file_doc_<?= $i; ?>" value="<?php echo !empty($data_cuka) ? $data_cuka['no_urut'] : ''; ?>" required>
                                  </span>
                              ...
                              <td>
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                  <span class="btn btn-magenta btn-file pulsate">
                                    <span class="fileinput-new">Pilih file</span>
                                    <span class="fileinput-exists">Change</span>
                                    <input type="file" name="file_doc_pend<?= $i; ?>" id="file_doc_pend<?= $i; ?>" value="<?php echo !empty($data_cuka) ? $data_cuka['no_urut'] : ''; ?>">
                                  </span>
                                  <span class="fileinput-filename"></span>
                                  <a href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none">&times;</a>
                                </div>
