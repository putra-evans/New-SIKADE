          ...
          <div class="panel panel-brown">
            ...
            <div class="panel-body">
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="input1 form-control tooltips" name="nama_lengkap" id="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo !empty($data_pensi) ? $data_pensi['nama_lengkap'] : set_value('nama_lengkap'); ?>" data-trigger="hover" data-original-title="Nama Lengkap yang akan digunakan">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="number" class="input1 form-control tooltips" name="nik" id="nik" placeholder="NIK(Nomor KTP Elektronik)" value="<?php echo !empty($data_pensi) ? $data_pensi['nik'] : set_value('nik'); ?>" data-trigger="hover" data-original-title="NIK(Nomor KTP Elektronik) yang akan digunakan">
                  <div class="help-block"></div>
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="input1 form-control tooltips" name="alamat" id="alamat" placeholder="Alamat Anda" value="<?php echo !empty($data_pensi) ? $data_pensi['alamat'] : set_value('alamat'); ?>" data-trigger="hover" data-original-title="Alamat Anda">
                  <div class="help-block"></div>
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="input1 form-control tooltips" name="pemda_lembaga_umum" id="pemda_lembaga_umum" placeholder="Pemda/Lembaga/Umum" value="<?php echo !empty($data_pensi) ? $data_pensi['pemda_lembaga_umum'] : set_value('pemda_lembaga_umum'); ?>" data-trigger="hover" data-original-title="Pemda/Lembaga/Umum">
                  <div class="help-block"></div>
                </div>
              </div>
            ...
            <div class="col-xs-12">
              <div class="panel panel-midnightblue">
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-offset-1 col-xs-9">
                      ...
                      <div class="table-responsive">
                        <input type="hidden" name="id_adminpensi" id="id_adminpensi">
                        <input type="hidden" name="status" id="status" value="<?= $data_pensi['status'] ?>">
                                  ...
                                  <td>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                      <span class="btn btn-magenta btn-file pulsate">
                                        ...
                                        <input type="file" class="uploadDokumen" name="file_doc_<?= $i; ?>" id="file_doc_<?= $i; ?>" value="<?php echo !empty($data_pensi) ? $data_pensi['no_urut'] : ''; ?>" data-idadminupload="<?= base64_encode($list->id_adminupload)  ?>" data-idadminpensi="<?= $this->uri->segment(5); ?>" data-idadministrasi="<?= base64_encode($list->id_administrasi)   ?>" data-id="<?= $i ?>">
                                  ...
                                  <td>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                      <span class="btn btn-magenta btn-file pulsate">
                                        ...
                                        <input type="file" class="uploadDokPend" name="file_doc_pend<?= $i; ?>" id="file_doc_pend<?= $i; ?>" value="<?php echo !empty($data_pensi) ? $data_pensi['no_urut'] : ''; ?>" data-idadminupload="<?= base64_encode($list->id_adminupload)  ?>" data-idadminpensi="<?= $this->uri->segment(5); ?>" data-idadministrasi="<?= base64_encode($list->id_administrasi)   ?>" data-id="<?= $i ?>">
                                      </span>
                                      <span class="fileinput-filename"></span>
                                      <a href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none">&times;</a>
                                    </div>
                  ...
                  <?php echo form_open_multipart(site_url('master-kade/adminpensi/create/save-ajukan'), array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'formAjukan')); ?>
                  <div class="panel-footer">
                    <div class="row">
                      <div class="col-sm-6 col-sm-offset-3">
                        <div class="btn-toolbar">
                          <input type="hidden" value="<?php echo base64_encode($data_pensi['id_adminpensi'])  ?>" name="id_adminpensi">
                          <input type="hidden" value="<?php echo $data_pensi['nama_lengkap']  ?>" name="nama_lengkap">
                          <button class="btn-success btn" type="submit" name="saveAjukan" id="saveAjukan"><i class="fa fa-check"></i> Ajukan</button>
                          <a href="<?= site_url('master-kade/adminpensi') ?>" class="btn-warning btn"><i class="fa fa-times"></i> Batal Simpan</a>
                        </div>
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  $('.uploadDokumen').change(function(e) {
    ...
    $.ajax({
      url: '<?= site_url('master-kade/adminpensi/create/insertadministrasi') ?>',
      type: 'post',
      dataType: 'json',
      data: data,
      cache: false,
  ...
  $('.uploadDokPend').change(function(e) {
    ...
    data.append(csrfName, $('input[name="' + csrfName + '"]').val());
    $.ajax({
      url: '<?= site_url('master-kade/adminpensi/create/insertpendukung') ?>',
      type: 'post',
      dataType: 'json',
      data: data,
      cache: false,
  ...
  $(document).on('click', '.printPdf', function(e) {
    var pensi = $('input[name="no_registrasi"]').val();
    url = site + 'master-kade/adminpensi/export-to-pdf?registration_number=' + pensi;
  ...
  jQuery(document).ready(function() {
    ...
    var id_adminpensi = "<?php echo  !empty($data_pensi) ? $data_pensi['id_adminpensi'] : '' ?>";
    if (id_adminpensi != '') {
      $('#id_adminpensi').val(id_adminpensi);
      $('[href="#upload1"]').tab('show');
      $('.input1').attr('readonly', true);
    }
    var status = "<?php echo  $data_pensi['status'] ?>";
    if (status == 'diajukan') {
      $('#status').val(status);
      $('[href="#profile1"]').tab('show');
    }
