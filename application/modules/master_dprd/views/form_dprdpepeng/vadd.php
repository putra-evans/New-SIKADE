<div class="container">
  <div class="panel-heading">
    <h4>Administrasi Pengesahan Pengangkatan dan Pemberhentian DPRD</h4>
  </div>
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="home1">
          <div class="panel panel-success">
            ...
            <?php echo form_open_multipart(site_url('master-dprd/dprdpepeng/create/save-register'), array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'formEntry')); ?>
            <?php echo form_hidden('no_registrasi', !empty($dprd_pepeng) ? $dprd_pepeng['no_urut'] : ''); ?>
            <div class="panel-body">
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="input1 form-control tooltips" name="nama_lengkap" id="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo !empty($dprd_pepeng) ? $dprd_pepeng['nama_lengkap'] : set_value('nama_lengkap'); ?>" data-trigger="hover" data-original-title="Nama Lengkap yang akan digunakan">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="input1 form-control tooltips" name="nik" id="nik" placeholder="NIK(Nomor KTP Elektronik)" value="<?php echo !empty($dprd_pepeng) ? $dprd_pepeng['nik'] : set_value('nik'); ?>" data-trigger="hover" data-original-title="NIK(Nomor KTP Elektronik) yang akan digunakan">
                  <div class="help-block"></div>
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="input1 form-control tooltips" name="alamat" id="alamat" placeholder="Alamat Anda" value="<?php echo !empty($dprd_pepeng) ? $dprd_pepeng['alamat'] : set_value('alamat'); ?>" data-trigger="hover" data-original-title="Alamat Anda">
                  <div class="help-block"></div>
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-6">
                  <input type="text" class="input1 form-control tooltips" name="pemda_lembaga_umum" id="pemda_lembaga_umum" placeholder="Pemda/Lembaga/Umum" value="<?php echo !empty($dprd_pepeng) ? $dprd_pepeng['pemda_lembaga_umum'] : set_value('pemda_lembaga_umum'); ?>" data-trigger="hover" data-original-title="Pemda/Lembaga/Umum">
                  <div class="help-block"></div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-sm-6 col-sm-offset-3">
                    <div class="btn-toolbar">
                      ...
                      <a href="<?= site_url('master-dprd/dprdpepeng') ?>" class="btn-warning btn"><i class="fa fa-times"></i> Kembali</a>
            ...
            <div class="col-xs-12">
              <div class="panel panel-midnightblue">
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-offset-1 col-xs-9">
                      ...
                      <div class="table-responsive">
                        <input type="hidden" name="id_dprdpepeng" id="id_dprdpepeng">
                        <input type="hidden" name="status" id="status" value="<?= $dprd_pepeng['status'] ?>">
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                      <span class="btn btn-magenta btn-file pulsate">
                                        ...
                                        <input type="file" class="uploadDokumen" name="file_doc_<?= $i; ?>" id="file_doc_<?= $i; ?>" value="<?php echo !empty($dprd_pepeng) ? $dprd_pepeng['no_urut'] : ''; ?>" data-idadminupload="<?= base64_encode($list->id_adminupload)  ?>" data-iddprdpepeng="<?= $this->uri->segment(5); ?>" data-idadministrasi="<?= base64_encode($list->id_administrasi)   ?>" data-id="<?= $i ?>">
                                  ...
                                  <td>
                                    <center>
                                      <?php if (!empty($abc)) { ?>
                                        <a class="btn btn-xs btn-primary" target="_blank" href="<?= site_url('upload/file/administrasi/dprdpepeng/' . $year . '/' . $month . '/' . $nik . '/' . $abc) ?>">View</a>
                                      <?php } else {
                                  ...
                                  <td>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                      <span class="btn btn-magenta btn-file pulsate">
                                        ...
                                        <input type="file" class="uploadDokPend" name="file_doc_pend<?= $i; ?>" id="file_doc_pend<?= $i; ?>" value="<?php echo !empty($dprd_pepeng) ? $dprd_pepeng['no_urut'] : ''; ?>" data-idadminupload="<?= base64_encode($list->id_adminupload)  ?>" data-iddprdpepeng="<?= $this->uri->segment(5); ?>" data-idadministrasi="<?= base64_encode($list->id_administrasi)   ?>" data-id="<?= $i ?>">
                                      </span>
                                      <span class="fileinput-filename"></span>
                                      <a href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none">&times;</a>
                                    </div>
                  ...
                  <?php echo form_open_multipart(site_url('master-dprd/dprdpepeng/create/save-ajukan'), array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'formAjukan')); ?>
                  <div class="panel-footer">
                    <div class="row">
                      <div class="col-sm-6 col-sm-offset-3">
                        <div class="btn-toolbar">
                          <input type="hidden" value="<?php echo base64_encode($dprd_pepeng['id_dprdpepeng'])  ?>" name="id_dprdpepeng">
                          <input type="hidden" value="<?php echo $dprd_pepeng['nama_lengkap']  ?>" name="nama_lengkap">
                          <button class="btn-success btn" type="submit" name="saveAjukan" id="saveAjukan"><i class="fa fa-check"></i> Ajukan</button>
                          <a href="<?= site_url('master-dprd/dprdpepeng') ?>" class="btn-warning btn"><i class="fa fa-times"></i> Batal Simpan</a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="table-responsive">
                        <table class="table table-condensed">
                          <h3><strong>Nomor Registrasi: <?php echo !empty($dprd_pepeng) ? $dprd_pepeng['no_urut'] : ''; ?></strong></h3>

                          <tbody>
                            <tr>
                              <td>Tanggal Registrasi</td>
                              <td>: <strong><?php echo !empty($dprd_pepeng) ? tgl_indo_registrasi($dprd_pepeng['create_date']) : ''; ?></strong></td>
                            </tr>
                            <tr>
                              <td>Jam Registrasi</td>
                              <td>: <strong><?php echo !empty($dprd_pepeng) ? tgl_indo_jam($dprd_pepeng['create_date']) : ''; ?> WIB</strong></td>
                            </tr>
                            <tr>
                              <td>Nama Lengkap</td>
                              <td>: <strong><?php echo !empty($dprd_pepeng) ? $dprd_pepeng['nama_lengkap'] : ''; ?></strong></td>
                            </tr>
                            <tr>
                              <td>NIK (Nomor Induk Kependudukan)</td>
                              <td>: <strong><?php echo !empty($dprd_pepeng) ? $dprd_pepeng['nik'] : ''; ?></strong></td>
                            </tr>
                            <tr>
                              <td>Alamat</td>
                              <td>: <strong><?php echo !empty($dprd_pepeng) ? $dprd_pepeng['alamat'] : ''; ?></strong></td>
                            </tr>
                            <tr>
                              <td>Pemda/Lembaga/Umum</td>
                              <td>: <strong><?php echo !empty($dprd_pepeng) ? $dprd_pepeng['pemda_lembaga_umum'] : ''; ?></strong></td>
                            </tr>
                            <tr>
                              <td>Nama Layanan</td>
                              <td>: <strong><?php echo !empty($dprd_pepeng) ? $dprd_pepeng['nm_layanan'] : ''; ?></strong></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
...
<script type="text/javascript">
  ...
  $('.uploadDokumen').change(function(e) {
    ...
    var id_dprdpepeng = $(this).data('iddprdpepeng');
    ...
    data.append('id_dprdpepeng', id_dprdpepeng);
    data.append('id_administrasi', id_administrasi);
    data.append(csrfName, $('input[name="' + csrfName + '"]').val());
    $.ajax({
      url: '<?= site_url('master-dprd/dprdpepeng/create/insertadministrasi') ?>',
      type: 'post',
      dataType: 'json',
      data: data,
      cache: false,
  ...
  $('.uploadDokPend').change(function(e) {
    ...
    data.append(csrfName, $('input[name="' + csrfName + '"]').val());
    $.ajax({
      url: '<?= site_url('master-dprd/dprdpepeng/create/insertpendukung') ?>',
      type: 'post',
      dataType: 'json',
      data: data,
      cache: false,
              ...
              $.ajax({
                ...
                if (data.status == 0) {
                  ...
                  $('#errEntry').html('<div class="alert alert-dismissable alert-success">' +
                    ...
                    '</div>');
                  // console.log(data)
                  window.location.href = site + 'master-dprd/dprdpepeng/create/new-register/' + data.kode;
      ...
      buttons: {
        ...
        "main": {
          ...
          callback: function(response) {
            if (response) {
              $.ajax({
                url: site + 'master-dprd/dprdpepeng/deletedokumenpendukung',
                type: "POST",
                data: postData,
                dataType: "json",
              }).done(function(data) {
  ...
  $(document).on('click', '.printPdf', function(e) {
    var dprdpepeng = $('input[name="no_registrasi"]').val();
    url = site + 'master-dprd/dprdpepeng/export-to-pdf?registration_number=' + dprdpepeng;
  ...
  jQuery(document).ready(function() {
    ...
    var id_dprdpepeng = "<?php echo  !empty($dprd_pepeng) ? $dprd_pepeng['id_dprdpepeng'] : '' ?>";
    if (id_dprdpepeng != '') {
      $('#id_dprdpepeng').val(id_dprdpepeng);
      $('[href="#upload1"]').tab('show');
      $('.input1').attr('readonly', true);
    }
    var status = "<?php echo  $dprd_pepeng['status'] ?>";
    if (status == 'diajukan') {
      $('#status').val(status);
      $('[href="#profile1"]').tab('show');
    }
