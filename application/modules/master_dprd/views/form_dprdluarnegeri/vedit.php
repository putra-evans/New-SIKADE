<div class="container">
  <div class="panel-heading">
    <?php
    // var_dump($data_dprdluarnegeri_diri);
    // exit;
    ?>
    <h4>Edit Permohonan <u><?= $data_dprdluarnegeri_diri[0]->nama_lengkap ?> </u> </h4>
  </div>
        ...
        <div class="tab-pane active" id="home1">
          <div class="panel panel-danger">
            ...
            <div class="panel-body">
              <?php echo form_open_multipart(site_url('master-dprd/dprdluarnegeri/update/proses-edit-data'), array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'formEntry')); ?>
              <div class="panel-body">
                <div class="form-group required">
                  ...
                  <div class="col-sm-6">
                    <input type="hidden" value="<?= $data_dprdluarnegeri_diri[0]->id_dprdluarnegeri ?>" name="id_dprdluarnegeri">
                    <input type="text" class="form-control tooltips" name="nama_lengkap" id="nama_lengkap" placeholder="Nama Lengkap" value="<?= $data_dprdluarnegeri_diri[0]->nama_lengkap ?>" data-trigger="hover" data-original-title="Nama Lengkap yang akan digunakan">
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-6">
                    <input type="number" class="form-control tooltips" name="nik" id="nik" placeholder="NIK(Nomor KTP Elektronik)" value="<?= $data_dprdluarnegeri_diri[0]->nik ?>" data-trigger="hover" data-original-title="NIK(Nomor KTP Elektronik) yang akan digunakan" readonly>
                    <div class="help-block"></div>
                  </div>
                </div>
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control tooltips" name="alamat" id="alamat" placeholder="Alamat Anda" value="<?= $data_dprdluarnegeri_diri[0]->alamat ?>" data-trigger="hover" data-original-title="Alamat Anda">
                    <div class="help-block"></div>
                  </div>
                </div>
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control tooltips" name="pemda_lembaga_umum" id="pemda_lembaga_umum" placeholder="Pemda/Lembaga/Umum" value="<?= $data_dprdluarnegeri_diri[0]->pemda_lembaga_umum ?>" data-trigger="hover" data-original-title="Pemda/Lembaga/Umum">
                    <div class="help-block"></div>
                  </div>
                </div>
                <div class="row">
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-striped" width="100%">
                        ...
                        <tbody>
                          ...
                          <?php $i = 1;
                          if (empty($data_dprdluarnegeri_diri)) { ?>
                            <tr>
                              <td align="center" colspan="4">Tidak ada file KTP</td>
                            </tr>
                          <?php } else {
                            ...
                            $nik        = $cek_file['nik'];
                            $id_dprdluarnegeri = $data_dprdluarnegeri_diri[0]->id_dprdluarnegeri;
                            $namafile     = $data_dprdluarnegeri_diri[0]->file_ktp;
                          ?>
                            <tr>
                              ...
                              <td>File KTP</td>
                              <td>
                                <input type="file" style="display: none;" class="uploadKTP" name="file_ktp_" id="file_ktp_<?= $id_dprdluarnegeri; ?>" data-iddprdluarnegeri="<?= $id_dprdluarnegeri; ?>">


                                <button type="button" role="button" onclick="$('#file_ktp_<?= $id_dprdluarnegeri; ?>').click();" class="btn btn-primary">Upload</button>
                                <input type="hidden" value="<?php echo $id_dprdluarnegeri ?>">
                                <input type="hidden" value="<?php echo $namafile ?>">
                              </td>
                              <td>
                                <center>
                                  <a class="btn btn-xs btn-primary" target="_blank" href="<?= site_url('upload/file/administrasi/dprdluarnegeri/' . $year . '/' . $month . '/' . $nik . '/' . $namafile) ?>">View</a>
                                </center>
                              </td>
                            </tr>
                          <?php
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-striped" width="100%">
                        ...
                        <tbody>
                          <?php echo form_open('', array('class' => 'form-horizontal row-border', 'role' => 'form')); ?>
                          <?php $i = 1;
                          if (empty($edit_dprdluarnegeri_adm)) { ?>
                            <tr>
                              <td align="center" colspan="4">Tidak Ada Dokumen Administrasi Utama</td>
                            </tr>
                            <?php } else {
                            foreach ($edit_dprdluarnegeri_adm as $key => $list) :
                              $abc = $list->nama_file;
                              $file_ktp   = $cek_file['file_ktp'];
                              $year       = $cek_file['year'];
                              $month      = $cek_file['month'];
                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                  <?php echo form_hidden('id_doc_pend[' . $i . ']', $list->id_dprdluarnegeri); ?>
                                  <input type="file" style="display: none;" class="uploadDokumen" name="file_doc_" id="file_doc_<?= $i; ?>" data-idadminupload="<?= base64_encode($list->id_adminupload) ?>" data-iddprdluarnegeri="<?= $this->uri->segment(4); ?>" data-idadministrasi="<?= base64_encode($list->id_administrasi)  ?>" data-id="<?= $i ?>">
                                  ...
                                  <input type="hidden" id="id_dprdluarnegeri" value="<?php echo $list->id_dprdluarnegeri ?>">
                                  <input type="hidden" value="<?php echo $list->id_dprdluarnegeri ?>">
                                </td>
                                <td>
                                  <center>
                                    <?php if (!empty($abc)) { ?>
                  ...
                  <div class="col-md-offset-1 col-xs-9">
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-striped" width="100%">
                        ...
                        <tbody>
                          <?php $i = 1;
                          if (empty($data_dprdluarnegeri_pend)) { ?>
                            <tr>
                              <td align="center" colspan="4">Tidak Ada Dokumen Pendukung</td>
                            </tr>
                            <?php } else {
                            foreach ($data_dprdluarnegeri_pend as $key => $list) :
                              $abc = $list->nama_file;
                              $file_ktp   = $cek_file['file_ktp'];
                              $year       = $cek_file['year'];
                              $month      = $cek_file['month'];
                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                  ...
                                  <input type="file" style="display: none;" class="uploadDokPend" name="file_dokumen_pend_" id="file_dokumen_pend_<?= $i ?>" data-iduploadpend="<?= $list->id_adminupload ?>" data-iddprdluarnegeripend="<?= base64_decode($this->uri->segment(4)); ?>" data-idadministrasi="<?= $list->id_administrasi  ?>" data-id="<?= $i ?>">
            ...
            <?php echo form_open_multipart(site_url('master-dprd/dprdluarnegeri/update/ajukan-kembali'), array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'formajukankembali')); ?>
            <div class="panel-footer">
              <input type="hidden" value="<?= $data_dprdluarnegeri_diri[0]->id_dprdluarnegeri ?>" name="id_dprdluarnegeri">
              <input type="hidden" value="<?= $data_dprdluarnegeri_diri[0]->nama_lengkap ?>" name="nama_lengkap">
              <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                  <div class="btn-toolbar">
...
<script type="text/javascript">
  ...
  $('.uploadKTP').change(function(e) {
    ...
    var dokumen = document.getElementById("file_ktp_" + id_dprdluarnegeri).files.length;
    data = new FormData();
    data.append('id_dprdluarnegeri', id_dprdluarnegeri);
    data.append('file_ktp', $('#file_ktp_' + id_dprdluarnegeri)[0].files[0]);
    data.append(csrfName, $('input[name="' + csrfName + '"]').val());
    $.ajax({
      url: '<?= site_url('master-dprd/dprdluarnegeri/update/proses-edit-ktp') ?>',
      type: 'post',
      dataType: 'json',
      data: data,
      cache: false,
      ...
      processData: false,
      beforeSend: function() {
        $('#file_ktp_' + id_dprdluarnegeri).addClass('disable');
        $('#file_ktp_' + id_dprdluarnegeri).text('uploading...');
      },
    }).done(function(data) {
  ...
  $('.uploadDokumen').change(function(e) {
    ...
    data.append(csrfName, $('input[name="' + csrfName + '"]').val());
    $.ajax({
      url: '<?= site_url('master-dprd/dprdluarnegeri/update/proses-edit') ?>',
      type: 'post',
      dataType: 'json',
      data: data,
      cache: false,
  ...
  $('.uploadDokPend').change(function(e) {
    ...
    var iddprdluarnegeripend = <?= base64_decode($this->uri->segment(4)); ?>;
    ...
    if (dokumenpend == 0) {
      ...
      data.append('iddprdluarnegeripend', iddprdluarnegeripend);
      data.append('id_administrasi', idadministrasi);
      data.append(csrfName, $('input[name="' + csrfName + '"]').val());
      $.ajax({
        url: '<?= site_url('master-dprd/dprdluarnegeri/update/proses-edit-pendukung') ?>',
        type: 'post',
        dataType: 'json',
        data: data,
        cache: false,
  ...
  function formReset() {
    $('#formEntry').attr('action', site + 'master-dprd/dprdperawa/update/proses-edit-data');
    $('#errEntry').html('');
              ...
              $.ajax({
                ...
                if (data.status == 0) {
                  ...
                  $('#errEntry').html('<div class="alert alert-dismissable alert-success">' +
                    ...
                    '</div>');
                  // location.reload();
                  window.location.href = site + 'master-dprd/dprdluarnegeri';
