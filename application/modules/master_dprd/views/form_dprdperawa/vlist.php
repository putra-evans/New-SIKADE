  ...
  <div class="row" id="formParent">
    <div class="col-xs-12 col-sm-12">
      <div class="btn-toolbar" style="margin-bottom: 15px">
        <a type="button" class="btn btn-primary" style="padding:11px 16px;" href="<?= site_url('master-dprd/dprdperawa/create/new-register'); ?>"><b><i class="fa fa-plus"></i> Tambah Baru </b></a>
      </div>
    </div>
    <div class="col-xs-12 col-sm-12">
    ...
    <div class="col-xs-12 col-sm-12">
      <div class="panel panel-info">
        <div class="panel-heading">
          <h4>Daftar Administrasi Pergantian antar waktu DPRD</h4>
        </div>
...
<div class="modal fade in" id="modalEntryForm" tabindex="-1" role="dialog" aria-labelledby="modalEntryLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" id="frmEntry">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(site_url('master-dprd/dprdperawa/create-pendukung'), array('id' => 'formEntry')); ?>
      <div class="modal-body" style="padding:15px 15px 5px 15px;">
        <div id="errEntry"></div>

        <div class="row">
          <?php echo form_hidden('id_dprdperawa', ''); ?>
...
<script type="text/javascript">
  ...
  $(document).on('click', '.btnUpload', function(e) {
    formReset();
    $('#formEntry').attr('action', site + 'master-dprd/dprdperawa/create-pendukung');
    var idAdmin = $(this).data('id');
    $('#modalEntryForm').modal({
      backdrop: 'static'
    });
    $('input[name="id_dprdperawa"]').val(idAdmin);
    // getDataGedung(token);
  });
  ...
  function getDataListdprdperawa() {
    $('#tbladministrasi').dataTable({
      ...
      "ordering": false,
      "ajax": {
        "url": site + "master-dprd/dprdperawa/listview",
        "type": "POST",
        "data": {
      ...
      buttons: {
        ...
        "main": {
          ...
          callback: function(response) {
            if (response) {
              $.ajax({
                url: site + 'master-dprd/dprdperawa/delete',
                type: "POST",
                data: postData,
                dataType: "json",
              }).done(function(data) {
