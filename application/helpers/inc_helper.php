...
/**
 * Fungsi status permohonan
 */
if (!function_exists('statusPermohonan')) {
...
// fungsi jenis dokumen

if (!function_exists('jenis')) {
  function jenis()
  {
    $jenis = array(
      'dokumen utama'     => "Dokumen Utama",
...
/* Fungsi convert status
*/
if (!function_exists('convert_status2')) {
  function convert_status2($id_status)
  {
    $status = array(
      0 => '<span class="label label-danger"><i class="fa fa-minus-square-o"></i> BELUM UPLOAD</span>',
      1 => '<span class="label label-success"><i class="fa fa-check-square-o" aria-hidden="true"></i> SUDAH UPLOAD</span>',
    );
    return $status[intval($id_status)];
  }
}
if (!function_exists('convert_status3')) {
  function convert_status3($id_status)
  {
    $status = array(
      // '' => '<span class="label label-info"><i class="fa fa-minus-square-o"></i> BELUM DIPROSES</span>',
      'belumdiajukan'  => '<span class="label label-info"><i class="fa fa-minus-square-o"></i> BELUM DIAJUKAN</span>',
      'diajukan'  => '<span class="label label-primary"><i class="fa fa-minus-square-o"></i> DIAJUKAN</span>',
      'selesai'   => '<span class="label label-success"><i class="fa fa-minus-square-o"></i> SELESAI</span>',
      'diproses'  => '<span class="label label-warning"><i class="fa fa-minus-square-o"></i> PROSES</span>',
      'ditolak'   => '<span class="label label-danger"><i class="fa fa-check-square-o" aria-hidden="true"></i> DITOLAK</span>',
    );
